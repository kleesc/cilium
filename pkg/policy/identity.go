...
// L4RuleContexts maps a rule context to a boolean.
type L4RuleContexts map[L4RuleContext]L7RuleContext

// NewL4RuleContexts returns a new L4RuleContexts created.
...
type L7RuleContext struct {
	...
	RedirectPort uint16
	// L4Installed specifies if the given rule is installed in the L4 BPF map
	L4Installed bool
}
