...
// resource set.
// ResourceWatcher implements ResourceVersionListener to get notified when new
...
// resource set.
func NewResourceWatcher(typeURL string, resourceSet ResourceSet, resourceAccessTimeout time.Duration) *ResourceWatcher {
	w := &ResourceWatcher{
		typeURL:               typeURL,
		resourceSet:           resourceSet,
